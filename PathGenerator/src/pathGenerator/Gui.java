        ...
        if (!txtFileName.getText().equals("")) {
            ...
            if (left != null || fl != null) {
                if (rdbtnTankDrive.isSelected()) {
                    lFile = new File(fileName + "_left.csv");
                    ...
                    File leftFile = new File(fileName + "_left_detailed.csv");
                    File rightFile = new File(fileName + "_right_detailed.csv");
                    ...
                    flFile = new File(fileName + "_FrontLeft.csv");
                    frFile = new File(fileName + "_FrontRight.csv");
                    blFile = new File(fileName + "_BackLeft.csv");
                    ...
                    // Detailed CSV with dt, x, y, position, velocity, acceleration, jerk, and heading
                    File frontLeftFile = new File(fileName + "_FrontLeft_detailed.csv");
                    File frontRightFile = new File(fileName + "_FrontRight_detailed.csv");
                    File backLeftFile = new File(fileName + "_BackLeft_detailed.csv");
                    File backRightFile = new File(fileName + "_BackRight_detailed.csv");
                ...
                preferenceFile = new File(fileName + "_Preferences.bot");
            ...
            JOptionPane.showMessageDialog(null, "The File Name & directory field is empty! \nPlease enter a file name and path!", "File Name Empty", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    }
