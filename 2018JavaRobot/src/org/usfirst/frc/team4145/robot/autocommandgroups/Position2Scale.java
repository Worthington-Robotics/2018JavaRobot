...
public class Position2Scale extends QueueGroup {
	...
	public Position2Scale(int autonumber) {
		if (autonumber == 0) {
			//Forward then rotate
			addSequential(new DriveTo(19 * 20, false), 500);
			addSequential(new GyroToAngle(90), 100);
			
			//Forward then rotate
			addSequential(new DriveTo(19 * 90, false), 500);
			addSequential(new GyroToAngle(-90), 100);
			
			//Forward then rotate and drop
			addSequential(new DriveTo(19 * 240, true), 500);
		...
		if (autonumber == 1) {
			//Forward then rotate
			addSequential(new DriveTo(19 * 60, false), 300);
			addSequential(new GyroToAngle(-90), 100);
			
			//Forward then rotate
			addSequential(new DriveTo(19 * 120, false), 500);
			addSequential(new GyroToAngle(90), 100);
			
			//Forward Toward Scale and Drop
			addSequential(new DriveTo(19 * 210, true), 500);
			addSequential(new GyroToAngle(45), 100);
			addParallel(new Command[] {new HighLiftUp(), new LiftToPosition(500), new DropForks()},  500);
			addSequential(new DropCube(true), 100);
		}
