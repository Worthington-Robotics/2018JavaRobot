...
public class AutoSelector {
    ...
    public static ConcurrentLinkedQueue<CommandQueueGroup> autoSelect(String GameData, String selection) {
        ...
        switch (usrAuto * 10 + fieldPos) {
            ...
            //case 11: return new Position1Switch(1).getQueuedStates();
            //case 12: return new Position1Switch(1).getQueuedStates();
            //case 13: return new Position1Switch(1).getQueuedStates();
            //case 14: return new Position1Switch(1).getQueuedStates();
            ...
            //case 32:
            //case 33:
            //case 34: return new ExchangeAll(1).getQueuedStates();
            ...
            //case 51: return new Position2Scale(1).getQueuedStates();
            //case 52: return new Position2Scale(0).getQueuedStates();
            //case 53: return new Position2Scale(1).getQueuedStates();
            //case 54: return new Position2Scale(0).getQueuedStates();

            //case 61:
            //case 62:
            //case 63:
            //case 64: return new ExchangeAll(2).getQueuedStates();

            //case 71: return new Position3Switch(0).getQueuedStates();
            //case 72: return new Position3Switch(0).getQueuedStates();
            //case 73: return new Position3Switch(1).getQueuedStates();
            //case 74: return new Position3Switch(1).getQueuedStates();
            ...
            //case 92:
            //case 93:
            //case 94: return new ExchangeAll(3).getQueuedStates();
