...
public class Constants {
    ...
    /**
     * Drivetrain periodic update rate
     * <p> this value permeates both the PID and periodic runnable</p>
     */
    public static double DRIVETRAIN_UPDATE_RATE = 0.005;
    public static double LOGGING_UPDATE_RATE = 0.020;

    public static String DRIVE_PATH_1 = "";
    public static String DRIVE_PATH_2 = "";
