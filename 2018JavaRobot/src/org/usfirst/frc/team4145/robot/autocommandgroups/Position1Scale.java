...
public class Position1Scale extends CommandGroupV2 {
    public Position1Scale(int autonumber) {
        ...
        if (autonumber == 0) {
            ...
            first_path.add(new Path.Waypoint(new Translation2d(120,0), 40.0, "lift"));
            first_path.add(new Path.Waypoint(new Translation2d(218, 0), 40.0));
            first_path.add(new Path.Waypoint(new Translation2d(254, 22), 40.0, "end"));
            first_path.add(new Path.Waypoint(new Translation2d(256, 24), 40.0));
